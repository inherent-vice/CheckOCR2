...
`checkocr2/ui/` contains extracted Tk helpers for panels, dialogs, icons, file-dialog path preparation, Excel/output-folder actions, coordinate capture/preview actions, grid actions, OCR run/stop/input-validation actions, options actions, and work completion actions.
