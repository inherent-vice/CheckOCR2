    ...
    def execute_ocr_workflow_threaded(self, ui_settings, output_dir_str, save_detail_images_bool):
        ...
        try:
            ...
            if not self.work_controller.is_stopped:
                ...
                self.data_manager.export_grid_to_excel_data(output_dir_str, self.app.input_excel_path.get())
...
class CheckCaptureOCRApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        main_container.grid_columnconfigure(1, weight=3) # 중앙 패널 확장 비율 증가
        main_container.grid_columnconfigure(2, weight=1, minsize=50) # 우측 로그 패널에 weight 부여 및 minsize 유지
    ...
    def _create_right_panel_content(self, parent):
        ...
        self.log_text_widget = tk.Text(log_text_frame, font=('Segoe UI', 9), relief='solid', bd=1, wrap='word', state='disabled')
        ...
        self.log_text_widget.tag_configure("DEBUG", foreground=self.theme_manager.get_color('secondary'))
...
OCR 자동화 애플리케이션 (EasyOCR 기반)"""
    ...
    def _create_section_frame_styled(self, parent, title, fill_parent=False):
        ...
        self.theme_manager.register_widget(frame, {'bg': 'surface', 'relief': 'groove', 'bd': 1, 'padx': 5, 'pady': 5})
        ...
        self.theme_manager.register_widget(content_frame, {'bg': 'white', 'padx': 5, 'pady': 5, 'relief': 'solid', 'bd': 1})
