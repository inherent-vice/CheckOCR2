...
STATUS_DONE = "완료"
STATUS_STOPPED = "중단됨"
STATUS_ERROR_CAPTURE_FAILED = "캡처 실패"
STATUS_ERROR_MISSING_CODE = "종목코드 없음"
STATUS_ERROR_PROCESSING = "처리 오류"
STATUS_ERROR_SKIPPED = "건너뜀"
...
ERROR_STATUS_KEYWORDS = ("오류", "실패", "없음", "건너")
