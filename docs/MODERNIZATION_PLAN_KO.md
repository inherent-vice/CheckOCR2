...
1. 실제 날짜/금리 crop fixture와 수동 검증된 `ground_truth_draft.csv`를 만든다.
2. `scripts\promote_ocr_fixtures.py --confirm-reviewed`로 `ground_truth.csv`에
   승격한 뒤 fixture audit를 통과시킨다.
