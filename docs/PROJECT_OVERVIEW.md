...
- `workflow_legacy_adapters.py`: legacy capture/OCR adapters used by the Tk
  workflow controller.
...
- `workflow_report_finalization.py`: success/failure run-report finalization
  used by the OCR workflow manager.
