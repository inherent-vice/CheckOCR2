...
| Keep package release gate green | Clean PyInstaller build plus `scripts/package_smoke.py ... --ocr-ready-mode real ... --require-clean-exit` | Strict package smoke: `596.408 MB`, startup `1.094s`, build date `2026-05-12T10:21:36+00:00`, `Ready`, isolated settings, clean exit. | Done |
