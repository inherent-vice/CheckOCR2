...
- Workflow, OCR, Excel, table, settings, paths, image-processing, runtime-state,
  run-report, queue-dispatch, and file/coordinates/timing/log panel seams now
  have test coverage.
...
startup `1.141` seconds, and the full test suite passed with 89 tests after
coordinates-panel extraction.
