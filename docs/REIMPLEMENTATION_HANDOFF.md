...
- Workflow, OCR, Excel, data-manager, table, settings, settings-binding, paths,
  ...
  coordinate capture/preview actions, grid/context-menu actions, log text
...
Latest code gate result: `ruff` passed, `pytest` passed with 249 tests,
...
PyInstaller release build after log-action extraction plus real package smoke
at about `596.382 MB` with startup `1.765` seconds and settings-file
