...
- Workflow, OCR, Excel, data-manager, table, settings, settings-binding, paths,
  ...
  file-dialog path preparation, application icons, OCR-start validation, and
...
Latest code gate result: `ruff` passed, `pytest` passed with 195 tests,
...
package smoke at about `596.374 MB` with startup `3.797` seconds and
